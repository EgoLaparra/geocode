...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.classifier_1 = nn.Linear(config.hidden_size, config.hidden_size)
        self.classifier_2 = nn.Linear(config.hidden_size, config.hidden_size)
        self.classifier_final = nn.Linear(config.hidden_size, self.num_labels)
        self.init_weights()
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None,
        ...
        final_pooled_output = self.dropout(pooled_output)
