...
class GeoComposeProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(self.pickle_load_large_file(os.path.join(data_dir, "model_input_desc_train_LOCATION.pkl")),
                                     self.pickle_load_large_file(os.path.join(data_dir, "model_input_paras_train_LOCATION.pkl")),
                                     self.pickle_load_large_file(os.path.join(data_dir, "model_input_target_train_LOCATION.pkl")),"train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {} dev".format(data_dir))
        return self._create_examples(self.pickle_load_large_file(os.path.join(data_dir, "model_input_desc_dev_LOCATION.pkl")),
                                     self.pickle_load_large_file(os.path.join(data_dir, "model_input_paras_dev_LOCATION.pkl")),
                                     self.pickle_load_large_file(os.path.join(data_dir, "model_input_target_dev_LOCATION.pkl")), "dev")
