...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        if bilinear:
            ...
            self.conv = DoubleConv_up(in_channels, out_channels, in_channels // 2)
        else:
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.inc = DoubleConv_up(self.n_channels, 64)
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None,
        ...
        final_x5 = self.classifier_final(output_2)
        final_x5 = final_x5.view(-1, x5_o, x5_w, x5_h)
        #print("self.down5: ", final_x5.shape)

        x = self.up1(final_x5, x4)
        x = self.up2(x, x3)
        x = self.up3(x, x2)
        x = self.up4(x, x1)
