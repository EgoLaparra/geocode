...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_target_dev', default='../../geocode-data/collection_samples/model_input_target_classification_60_dev.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_paras_dev', default='../../geocode-data/collection_samples/model_input_paras_classification_60_dev.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_dev',
                        default='../../geocode-data/collection_samples/model_input_desc_classification_60_dev.pkl',
                        type=str,
                        help='path of data collections samples')
