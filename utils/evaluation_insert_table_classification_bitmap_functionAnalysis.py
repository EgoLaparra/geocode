...
entity2target = pickle_load_large_file('/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_target_classification_bitmap_boundary_128_dev.pkl')
entityID2boundary = pickle_load_large_file('/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_boundary_classification_bitmap_boundary_128_dev.pkl')
...
for idx,(entity_id, target_bitmap) in enumerate(entity2target.items()):
    ...
    grid = bounded_grid(geom, 128, min_bound, max_bound)
