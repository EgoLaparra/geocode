...
entity2target = pickle_load_large_file('../../geocode-data/collection_samples/model_input_target_classification_bitmap_200_dev.pkl')
entityID2boundary = pickle_load_large_file('../../geocode-data/collection_samples/model_input_boundary_classification_bitmap_200_dev.pkl')
