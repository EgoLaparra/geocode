...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_target_train', default='../../geocode-data/collection_samples/model_input_target_classification_bitmap_10_train.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_paras_train', default='../../geocode-data/collection_samples/model_input_paras_classification_bitmap_10_train.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_train',
                        default='../../geocode-data/collection_samples/model_input_desc_classification_bitmap_10_train.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_boundary_train',
                        default='../../geocode-data/collection_samples/model_input_boundary_classification_bitmap_10_train.pkl',
                        type=str,
                        help='path of data collections samples')
    ...
    with tqdm(total=num_entities, desc='Entities') as progress_bar:
        ...
        while entity is not None:
            ...
            try:
                ...
                if entity_max[0] < min_bound[0] or entity_max[1] < min_bound[1] or entity_min[0] > max_bound[0] or \
                        entity_min[1] > max_bound[1]:
