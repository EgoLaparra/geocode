...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_target_train', default='../../geocode-data/collection_samples/model_input_target_classification_relative_50_train.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_paras_train', default='../../geocode-data/collection_samples/model_input_paras_classification_relative_50_train.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_train',
                        default='../../geocode-data/collection_samples/model_input_desc_classification_relative_50_train.pkl',
                        type=str,
                        help='path of data collections samples')
