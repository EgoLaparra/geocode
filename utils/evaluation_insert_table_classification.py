...
with open('classification_relative_results/eval_preds_50_epoch50.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative/output_50_epoch50']
#print(value)
print(len(value))
