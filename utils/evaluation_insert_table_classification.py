...
with open('classification_relative_results/eval_preds_26_epoch100.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative/output_26_epoch100']
#print(value)
print(len(value))
