...
with open('classification_relative_boundary_results/eval_preds_100_epoch50.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative_boundary/output_100_epoch50']
#print(value)
print(len(value))
