...
with open('classification_relative_boundary_results/eval_preds_26_LOCATION_epoch50.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative_boundary_LOCATION/output_26_epoch50']
#print(value)
print(len(value))
