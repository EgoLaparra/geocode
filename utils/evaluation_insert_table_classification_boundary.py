...
with open('classification_relative_boundary_results/eval_preds_100_epoch100.json', 'r') as file:
    output_raw = json.load(file)

entity2desc = pickle_load_large_file('../../geocode-data/collection_samples/model_input_desc_classification_relative_boundary_100_dev.pkl')
entityID2boundary = pickle_load_large_file('../../geocode-data/collection_samples/model_input_boundary_classification_relative_boundary_100_dev.pkl')
...
value = output_raw['preds_Compositional_classification_relative_boundary/output_100_large_epoch100']
#print(value)
print(len(value))
...
for idx, prediction in enumerate(value):
    ...
    prediction_values = index_to_tile_relative(prediction, 100, min_bound, max_bound)
