...
with open('classification_relative_boundary_results/eval_preds_100_epoch50_nochecklimit.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative_boundary/output_100_epoch50_nochecklimit']
#print(value)
print(len(value))
