...
with open('classification_relative_boundary_results/eval_preds_50_epoch300.json', 'r') as file:
...
value = output_raw['preds_Compositional_classification_relative_boundary/output_50_epoch300']
#print(value)
print(len(value))
