...
with open('classification_relative_boundary_results/eval_preds_50_epoch100.json', 'r') as file:
    output_raw = json.load(file)

entity2desc = pickle_load_large_file('../../geocode-data/collection_samples/model_input_desc_classification_relative_boundary_50_dev.pkl')
entityID2boundary = pickle_load_large_file('../../geocode-data/collection_samples/model_input_boundary_classification_relative_boundary_50_dev.pkl')
...
value = output_raw['preds_Compositional_classification_relative_boundary/output_50_large_epoc100']
#print(value)
print(len(value))
...
for idx, prediction in enumerate(value):
    ...
    prediction_values = index_to_tile_relative(prediction, 50, min_bound, max_bound)
