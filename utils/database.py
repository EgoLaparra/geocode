...
SQL = {"geometry":          {"query": """select geom from geometries 
       ...
       "type":              {"query": """select st_geometrytype('%s');""",
                             "single_output": True},
       "srid":              {"query": """select st_srid('%s'::%s);""",
                             "single_output": True},
       "setsrid":           {"query": """select st_setsrid('%s'::%s, %s);""",
                             "single_output": True},
       "x":                 {"query": """select st_x('%s');""",
                             "single_output": True},
       "y":                 {"query": """select st_y('%s');""",
                             "single_output": True},
       "xmax":              {"query": """select st_xmax('%s'::geometry);""",
                             "single_output": True},
       "ymax":              {"query": """select st_ymax('%s'::geometry);""",
                             "single_output": True},
       "xmin":              {"query": """select st_xmin('%s'::geometry);""",
                             "single_output": True},
       "ymin":              {"query": """select st_ymin('%s'::geometry);""",
                             "single_output": True},
       "area":              {"query": """select st_area('%s'::%s);""",
                             "single_output": True},
       ...
       "closest_point":     {"query": """select st_closestpoint('%s', '%s');""",
                             "single_output": True},
       "distance":          {"query": """select st_distance('%s'::%s, '%s'::%s);""",
                             "single_output": True},
       "max_distance":      {"query": """select st_maxdistance('%s', '%s');""",
                             "single_output": True},
       "hausdorff":         {"query": """select st_hausdorffdistance('%s', '%s');""",
                             "single_output": True},
       "azimuth":           {"query": """select degrees(st_azimuth('%s'::geometry, '%s'::geometry));""",
                             "single_output": True},
       ...
       "geography":         {"query": """select Geography('%s') as geom;""",
                             "single_output": True},
       "buffer":            {"query": """select st_buffer('%s'::%s, %s);""",
                             "single_output": True},
       "make_valid":        {"query": """select st_makevalid('%s');""",
                             "single_output": True},
       "prediction":        {"query": """select geom from %s where entity_id = '%s';""",
                             "single_output": False},
       ...
       "pixelaspolygons":   {"query": """select (polygons).geom from 
                             ...
                             "single_output": False},
       "clip":              {"query": """select st_clip('%s', '%s');""",
                             "single_output": True},
       "aspng":             {"query": """select st_aspng('%s');""",
                             "single_output": True}
       }
