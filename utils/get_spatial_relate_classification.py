...
if __name__ == '__main__':
    ...
    parser.add_argument('--xml_filepath_train', default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/geocode-data/collection_samples/train_samples.xml', type=str,
    ...
    pickle_dump_large_file(linkID2relate, args.output_relate_train)
    pickle_dump_large_file(linkID2azimuth, args.output_azimuth_train)
    pickle_dump_large_file(linkID2distance, args.output_distance_train)
    pickle_dump_large_file(linkID2desc, args.output_desc_train)
