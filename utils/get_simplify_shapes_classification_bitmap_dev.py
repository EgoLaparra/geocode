...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_target_dev', default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_target_classification_bitmap_boundary_64_dev.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_paras_dev', default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_paras_classification_bitmap_boundary_64_dev.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_dev',
                        default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_desc_classification_bitmap_boundary_64_dev.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_boundary_dev',
                        default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_boundary_classification_bitmap_boundary_64_dev.pkl',
                        type=str,
                        help='path of data collections samples')
