...
if __name__ == '__main__':
    ...
    parser.add_argument('--xml_filepath_dev', default='../../geocode-data/collection_samples_new/dev_samples.xml', type=str,
                        help='path of data collections')
    parser.add_argument('--sample_size', default=50, type=int,
                        help='number of sample datas')
    parser.add_argument('--output_relate_dev', default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_target_relate_dev.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_azimuth_dev', default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_target_azimuth_dev.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_distance_dev',
                        default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_target_distance_dev.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_dev',
                        default='/xdisk/bethard/zeyuzhang/Geo-Compositional_data/model_input_desc_dev.pkl',
                        type=str,
                        help='path of data collections samples')
