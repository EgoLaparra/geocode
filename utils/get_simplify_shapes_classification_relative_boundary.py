...
if __name__ == '__main__':
    ...
    parser.add_argument('--xml_filepath_train', default='../../geocode-data/collection_samples/train_samples_large.xml', type=str,
                        help='path of data collections')
    parser.add_argument('--sample_size', default=50, type=int,
                        help='number of sample datas')
    parser.add_argument('--output_target_train', default='../../geocode-data/collection_samples/model_input_target_classification_relative_boundary_10_large_train.pkl', type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_paras_train', default='../../geocode-data/collection_samples/model_input_paras_classification_relative_boundary_10_large_train.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_desc_train',
                        default='../../geocode-data/collection_samples/model_input_desc_classification_relative_boundary_10_large_train.pkl',
                        type=str,
                        help='path of data collections samples')
    parser.add_argument('--output_boundary_train',
                        default='../../geocode-data/collection_samples/model_input_boundary_classification_relative_boundary_10_large_train.pkl',
                        type=str,
                        help='path of data collections samples')
        ...
        try:
            ...
            for p in entity.xpath('./p'):
                ...
                for e, link in enumerate(p.xpath('./link')):
                    ...
                    link_classification_label = coord_to_index_relative((link_central_x, link_central_y), args.polygon_size, min_bound, max_bound)
            ...
            entity_classification_label = coord_to_index_relative((entity_central_x, entity_central_y), args.polygon_size, min_bound, max_bound)
